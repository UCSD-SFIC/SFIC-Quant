...
export const rows = [
  ...
  createData(4, "BR S&P 510", 91, "ETF", 256, 50, 206, -10, 0.35),
  createData(4, "BR S&P 512", 92, "ETF", 256, 50, 206, -10, 0.35),
  createData(4, "BR S&P 503", 93, "ETF", 256, 50, 206, -10, 0.35),
  createData(4, "BR S&P 502", 94, "ETF", 256, 50, 206, -10, 0.35),
  createData(4, "BR AMZN", 95, "ETF", 256, 50, 206, -10, 0.35),
  createData(4, "BR NET", 96, "ETF", 256, 50, 206, -10, 0.35),
  createData(4, "BR QCOM", 97, "ETF", 256, 50, 206, -10, 0.35),
  createData(4, "BR APPL", 98, "ETF", 256, 50, 206, -10, 0.35),
  createData(4, "BR NVDA", 99, "ETF", 256, 50, 206, -10, 0.35),
  createData(4, "BR Dow", 90, "ETF", 256, 50, 206, -10, 0.35),
];
